...
void prosesFilter(Rumah *r)
{
    ...
    int tindakan_dilakukan_sesi_ini = 0; // Melacak apakah ada aksi di sesi filter.c ini
    ...
    do
    {
        ...
        // Kalimat informasi kesempatan filter yang diperbaiki
        ...
        if ((*r).aksiFilterTelahDigunakan < 3) { // Hanya tawarkan opsi filter jika masih ada kesempatan
        ...
        int ch_clear; while ((ch_clear = getchar()) != '\n' && ch_clear != EOF); 
            ...
            if ((*r).aksiFilterTelahDigunakan < 3) {
                ...
                if ((*r).kekeruhan > 5) {
                    ...
                    if ((*r).kekeruhan >= 10) {
                        ...
                        (*r).kekeruhan -= 2;
                    } else { // kekeruhan adalah 6
                        (*r).kekeruhan -= 1;
                    }
                    if ((*r).kekeruhan < 0) (*r).kekeruhan = 0; 
